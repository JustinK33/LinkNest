class FixAnalyticsTables < ActiveRecord::Migration[8.1]
  def change
    create_table :link_clicks unless table_exists?(:link_clicks) do |t|
    ...
    add_index :link_clicks, :created_at unless index_exists?(:link_clicks, :created_at) # For time-range queries
  end
end
